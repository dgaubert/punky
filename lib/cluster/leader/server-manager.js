    ...
    return new Promise((resolve, reject) => {
      ...
      server.once('exit', () => {
        if (!server.exitedAfterDisconnect) {
          return reject(new Error('Server exited accidentaly'))
        }
